...
set_property IOSTANDARD LVCMOS33 [get_ports {input_hw[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {input_hw[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {input_hw[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {input_hw[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {input_hw[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {input_hw[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {input_hw[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {input_hw[0]}]
set_property PACKAGE_PIN A2 [get_ports {input_hw[7]}]
set_property PACKAGE_PIN C4 [get_ports {input_hw[6]}]
set_property PACKAGE_PIN D4 [get_ports {input_hw[5]}]
set_property PACKAGE_PIN A3 [get_ports {input_hw[4]}]
set_property PACKAGE_PIN B2 [get_ports {input_hw[3]}]
set_property PACKAGE_PIN C1 [get_ports {input_hw[2]}]
set_property PACKAGE_PIN D2 [get_ports {input_hw[1]}]
set_property PACKAGE_PIN F1 [get_ports {input_hw[0]}]
